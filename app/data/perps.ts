...
export const PERPS = [
  ...
  },
  {
    ...
    tier: "S",
    name: "Bulk",
    ref: "https://early.bulk.trade/deposit?ref=capy",
    refCode: "capy",
    logo: "/bulk.svg",
    boost: "Deposit to earn points",
    farm: "Deposit campaign + early points farming",
    seoKeywords: [
      "bulk referral code",
      "bulk trade referral",
      "bulk trade deposit points",
      "bulk point calculator",
      "bulk points calculator",
      "bulk airdrop calculator",
      "bulk trade points campaign",
      "early bulk trade deposit",
    ],
  },
  {
    slug: "extended",
...
export const PERSONAL_FUNDING_EXCHANGES: Record<string, FundingExchangeMeta> = {
  ...
  bulk: {
    ...
    label: "Bulk",
    intervalHours: 8,
    tradeUrl: "https://early.bulk.trade/deposit?ref=capy",
    hasPersonalRef: true,
  },
  hibachi: {
    key: "hibachi",
...
export const GENERIC_EXCHANGE_URLS: Record<string, string> = {
  aevo: "https://app.aevo.xyz/",
  apex: "https://pro.apex.exchange/",
  apex_protocol: "https://pro.apex.exchange/",
  ...
  reya: "https://app.reya.xyz/trade",
  standx: "https://app.standx.com/",
  tradexyz: "https://www.trade.xyz/",
