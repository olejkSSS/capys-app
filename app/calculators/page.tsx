          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {calculators.map((calculator) => (
              <Link
                ...
                className="capys-card group flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.035] p-4 transition hover:-translate-y-0.5 hover:border-cyan-300/35 hover:bg-white/[0.065]"
              >
                <Image
                  src={calculator.logo}
